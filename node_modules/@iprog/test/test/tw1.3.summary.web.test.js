...
describe("TW1.3  Vue/React  Conditional Rendering: person/persons", function tw1_3_persons() {

	afterEach(cleanup);

	it.for([
		{ people: 1, expected: { header: "Summary for 1 person:" } },
        { people: 5, expected: { header: "Summary for 5 persons:" } },
	])("shows singular or plural in header based on people count", function tw1_3_persons_test(p, test) {
